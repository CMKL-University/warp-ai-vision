...
- 📝 **Fast-forward** - what will we cover in this competency?
- 🗂 **Project Expectation** - team work is always fun!
...
<img border="rounded" src="https://github.com/akkarit.png">

<img border="rounded" src="https://github.com/paleumm.png">

<img border="rounded" src="https://github.com/seksu.png">

Akkarit Sangpetch<br/>Instructor<br/>`@akkarit`

Permpoon Boonyarit<br/>Teaching Assistant (Lab)<br/>`@paleumm`

Jarukit Suchat<br/>Teaching Assistant (Tech)<br/>`@seksu`
...
- Given input images/videos
- Processing (with fancy math)
- Output (semantic or decision)
