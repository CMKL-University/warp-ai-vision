...
const config = {
  ...
  organizationName: 'CMKL-University', // Usually your GitHub org/user name.
  projectName: 'warp-ai-vision', // Usually your repo name.
    ...
    ({
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/CMKL-University/warp-ai-vision',
            label: 'GitHub',
            position: 'right',
          },
        ],
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'Twitter',
                href: 'https://twitter.com/cmkluniversity',
              },
            ],
          },
          {
